    ...
    <div class="homeElements">
        <div class="profileBox">
            ...
            <button 
                ...
                class = "createButton openEditModal"
                value=""
            >
                CREATE CONTACT
            </button>
        ...
        <div class="contactListContainer">
            <table class="contactList" id="contactList">
                <tr class="contactListHeading">
                    <th class="listProfile"></th>
                    <th class="listName">NAME</th>
                    <th class="listEmail">EMAIL ID</th>
                    <th class="listPhone">PHONE NUMBER</th>
                ...
                <cfloop query="rc.contactList">
                    ...
                    <cfoutput>
                        <tr class="contactListItem" id="contactItem_#rc.contactList.contactId#">
                            ...
                            <td class="listName">#rc.contactList.firstName# #rc.contactList.lastName# </td>
                            <td class="listEmail">#rc.contactList.emailId#</td>
                            <td class="listPhone">#rc.contactList.phoneNumber#</td>
                            <td class="listButton">
                                <button 
                                    type="button" 
                                    value="#rc.contactList.contactId#" 
                                    class = "contactButtons openViewModal"
                                    data-bs-toggle="modal" 
                                ...
                                <button type="button" 
                                    value="#rc.contactList.contactId#" 
                                    class = "openEditModal contactButtons"
                                    data-bs-toggle="modal" 
                                    data-bs-target="##editModal" 
                                >
                                    EDIT
                                ...
                                <button type="button" 
                                    value="#rc.contactList.contactId#" 
                                    class = "contactButtons deleteContact"
                                >
                                    DELETE
                                </button>
                            </td>
